...
if __name__ == '__main__':
    ...
    parser.add_argument('-ts', '--train_set', type=str,
                        default='output_data/cc_web_video_features.npy',
                        help='Path to the .npy file that contains the global '
                             'video vectors of the train set')
    parser.add_argument('-tr', '--triplets', type=str,
                        default='output_data/cc_web_video_triplets.npy',
